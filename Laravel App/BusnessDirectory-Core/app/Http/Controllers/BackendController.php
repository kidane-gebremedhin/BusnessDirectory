...
$img = \Image::make(base64_decode($base64_str));
 ...
 $complex_building=complex_building::where('name', '=', $request->name)->first();
    ...
    public function remote_login(Request $request)
    {
        ...
        if($username==null || $password==null){
            $data = array('type' => 'authentication', 'success' => false, 'message'=>'Login Failed! Please fill the fields.');
            return response()->json($data);
        }
    ...
    $data = array('type' => 'authentication', 'success' => false, 'message'=>'Login Failed! Incorrect Credentials');
    return response()->json($data);
    }
