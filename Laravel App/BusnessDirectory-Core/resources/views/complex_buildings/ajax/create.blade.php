<div class="col-md-12">
  <div class="col-md-8">
    {{Form::open(array("route"=>"complex_buildings.store", "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('complex_buildings.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading">
        {{App\Global_var::getLangString('Create_New_Complex_Building', $language_strings)}}
