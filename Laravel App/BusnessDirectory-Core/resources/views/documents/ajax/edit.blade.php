                    ...
                    <div class="tab-pane fade active in" id="orgDetails">
                        ...
                        <label class="nextUrl" nextUrl="{{route('users.show', $user->id)}}" />
                            ...
                            <div class="col-md-4">                             
                                ...
                                <div class="form-group">
                                    <label for="email" class="control-label"> {{App\Global_var::getLangString('Email', $language_strings)}}({{App\Global_var::getLangString('Optional', $language_strings)}})</label>
                                    {{ Form::text('email', null, array('class'=>'form-control'))}}
                                </div>
                                <div class="form-group">
                                    <label for="email" class="control-label" > {{App\Global_var::getLangString('Phone_Number', $language_strings)}}</label>
                                    {{ Form::text('phoneNumber', null, array('class'=>'number form-control'))}}
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">                             
                                ...
                                <div class="form-group">
                                    <label for="email" class="control-label">{{App\Global_var::getLangString('Zone', $language_strings)}}</label>
                                ...
                                <div class="form-group">
                                    <label for="email" class="control-label" > {{App\Global_var::getLangString('Wereda', $language_strings)}}</label>
