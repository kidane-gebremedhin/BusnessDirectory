                    ...
                    <div class="col-md-4"> 
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <!-- <label class="control-label"> {{App\Global_var::getLangString('Document_Type', $language_strings)}}</label> -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('author_email', null, array('class'=>'author_email author_elem form-control', 'required'=>'true'))}}
                            </div>
                            <div class="form-group">
                                <label class="control-label"> {{App\Global_var::getLangString('Phone_Number', $language_strings)}}</label>
                                {{ Form::text('author_phoneNumber', null, array('class'=>'author_phoneNumber author_elem form-control', 'required'=>'true'))}}
                            </div>
                        </div>
                        </div>
                        </div>
