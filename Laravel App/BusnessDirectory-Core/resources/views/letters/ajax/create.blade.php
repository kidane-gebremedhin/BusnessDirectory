<div class="col-md-12">
  <div class="col-md-8">
    {{Form::open(array("route"=>"letters.store", "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('letters.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading">
        {{App\Global_var::getLangString('Create_New_letter', $language_strings)}}
